    ...
    <form method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data">
        ...
        <div class="row g-2">
            ...
            <div class="col-6">
                ...
                <input type="date" name="tgl_lahir" class="form-control @if($errors->has('tgl_lahir')) is-invalid @endif" placeholder="Masukkan Tanggal Lahir" value="{{old('tgl_lahir')}}">                  
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="telepon" class="form-control" placeholder="Masukan Nomer Telepon" value="{{ old('telepon') }}">
                </div>
            </div>
            <div class="col-6">                
            ...
            <div class="col-6">
                <label for="unit_kerja">Unit Kerja</label>
                    <select class="form-select" name="unit_kerja" aria-label="Default select example">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" name="jabatan" id="jabatan" class="form-control" placeholder="Masukan Jabatan" value="{{ old('jabatan') }}">
                </div>
            </div>
                <div class="col-6">
